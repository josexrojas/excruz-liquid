...
define("URL_OK",       "http://192.168.5.53/epagos/post2/ok2.php");
//define("URL_OK",       "http://www.exaltaciondelacruz.gov.ar/index.php?option=com_serverwrapper&Itemid=150");



//TODO: reemplazar por su URL para el caso de pago con errores
define("URL_ERROR",    "http://192.168.5.53/epagos/post2/error.php");
//define("URL_ERROR",    "http://www.exaltaciondelacruz.gov.ar/index.php?option=com_serverwrapper&Itemid=144");
...
for ($i=0; $i<count($_GET['id_item']);$i++)
{
  ...
  $datos_post = array(
    'numero_operacion' => $_GET['id_item'][0], //GET
    ...
    'fp_permitidas' => serialize(array(1, 2, 3, 9, 10, 11, 14, 15,28,4,5,8,16,13,18,19,20,21,22,23,33,32,31,30,29,17,25,6,7,26,27)),
