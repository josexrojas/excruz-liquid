...
CODEBASE="http://<?=$Servidor?>/Reporte/reporte.cab#version=<?=VersionReporte();?>" HEIGHT=749 WIDTH=870 VIEWASTEXT>
	...
	<PARAM NAME="Pagina" VALUE="/listadoRecibosPrint2.php?CentroCostos=<?=$CentroCostos?>&TipoRelacion=<?=$TipoRelacion?>&FechaPeriodo=<?=$FechaPeriodo?>&NumeroLiquidacion=<?=$NumeroLiquidacion?>&LegDesde=<?=$LegDesde?>&LegHasta=<?=$LegHasta?>&LP=<?=$LP?>">
</OBJECT>
</BODY>
</HTML>
