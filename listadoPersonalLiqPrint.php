...
$Mes = LimpiarNumero($_GET["Mes"]);
$Ano = LimpiarNumero($_GET["Ano"]);
...
CODEBASE="http://<?=$Servidor?>/Reporte/reporte.cab#version=<?=VersionReporte();?>" HEIGHT=749 WIDTH=870 VIEWASTEXT>
	...
	<PARAM NAME="Pagina" VALUE="/listadoPersonalLiqPrint2.php?TipoRelacion=<?=$TipoRelacion?>&Mes=<?=$Mes?>&Ano=<?=$Ano?>&TR=<?=$TR?>&Jur=<?=$Jur?>">
</OBJECT>
</BODY>
</HTML>
