...
<H1>Listado historico de Modulo de horas</H1>
<?php

$rs = pg_query($db, "
select r.\"Legajo\", e.\"Nombre\" || ' ' || e.\"Apellido\", \"Fecha\", SUM(\"Haber2\") from \"tblRecibos\" r inner join \"tblEmpleados\" e on r.\"Legajo\"=e.\"Legajo\" where \"AliasID\" = 191 and \"Fecha\">='2016-01-01'
