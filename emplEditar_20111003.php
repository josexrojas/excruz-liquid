...
if (isset($accion2) && $accion2 == 'Aceptar Cambios')
{
	...
	$Decreto	= LimpiarVariable($_POST["Decreto"]);
	...
	$Decreto 	= ParametroSQL($Decreto, 'varchar');
...
<?
	...
	else
	{
		...
		$sql.= " \"HorasDiarias\""; 
		$sql.= " FROM \"tblCategoriasPorEmpresa\""; 
		$sql.= " WHERE \"EmpresaID\" = $EmpresaID"; 
		$sql.= " AND \"Agrupamiento\" = $Agrupamiento"; 
...
?>
	...
	<tr>
		...
		<td class=derecho>
			<input type=text id=SueldoBasico name=SueldoBasico disabled value="<?=$SueldoBasico?>">
	...
	<tr>
		...
		<td class=derecho>
			<input type=text id=HorasDiarias name=HorasDiarias disabled value="<?=$HorasDiarias?>">
			<label id="lblHorasDiarias" style="display:none; color:#FF0000;"><-- Ingreso Manual</label>
		</td>
	</tr>
	<tr>
...
<table class="datauser" align="left">
	...
	<tr>	
		<td class="izquierdo">Decreto Ingreso:</td>
		<td class=derecho>
			<input type=text id=Decreto name=FechaIng value="<?=$Decreto?>" size=11>
		</td>
	</tr>
	<tr>	
