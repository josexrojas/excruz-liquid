...
<HTML>
<HEAD>
<TITLE>Estadistica de Conceptos Liquidados</TITLE>
</HEAD>
...
CODEBASE="http://<?=$Servidor?>/Reporte/reporte.cab#version=<?=VersionReporte();?>" HEIGHT=749 WIDTH=870 VIEWASTEXT>
	...
	<PARAM NAME="Pagina" VALUE="/listadoEstConcLiqPrint2.php?FechaPeriodo=<?=$FechaPeriodo?>&NumeroLiquidacion=<?=$NumeroLiquidacion?>&TR=<?=$TR?>&Jur=<?=$Jur?>&TP=<?=$TP?>">
</OBJECT>
</BODY>
</HTML>
