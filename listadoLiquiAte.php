...
<!--
	function BajarListado(sArch){
		...
		document.frmListadoLiquiATE.submit();
	}
...
<form name=frmListadoLiquiATE action=listadoLiquiAte.php method=post>
...
where re1.\"EmpresaID\" = re.\"EmpresaID\" and re1.\"SucursalID\" = re.\"SucursalID\" and re1.\"Fecha\" = re.\"Fecha\"
and re1.\"NumeroLiquidacion\" = re.\"NumeroLiquidacion\" and re1.\"Legajo\" = re.\"Legajo\" 
and re1.\"AliasID\" in (22)) as \"CuotaAte2\",

(select sum(\"Descuento\") from \"tblRecibos\" re1 
where re1.\"EmpresaID\" = re.\"EmpresaID\" and re1.\"SucursalID\" = re.\"SucursalID\" and re1.\"Fecha\" = re.\"Fecha\"
and re1.\"NumeroLiquidacion\" = re.\"NumeroLiquidacion\" and re1.\"Legajo\" = re.\"Legajo\" 
and re1.\"AliasID\" in (75)) as \"CuotaCosegAte3\"
...
?>
<H1>Listado de liquidaciones de A.T.E.</H1>
...
?>
			...
			<tr><th>Leg</th><th>Apellido y Nombre</th><th>Sueldo Bruto</th><th>CUOTA <br />ATE 2,2%</th><th>CO-SEG <br />ATE 3%</th></tr>
<?
		}
		$R1 = FormatearImporte($row['SueldoBruto']);
		$R2 = FormatearImporte($row['CuotaAte2']);
		$R3 = FormatearImporte($row['CuotaCosegAte3']);
...
?>
		<tr><td><?=$row['Legajo']?></td><td><?=$ApeyNom?></td><td><?=$R1?></td><td><?=$R2?></td><td><?=$R3?></td></tr>
<?
		if ($R1 == 0) $R1 = '0';
		if ($R2 == 0) $R2 = '0';
		if ($R3 == 0) $R3 = '0';
		...
		if ($cont == 0)
		{
			...
			$Detalle .= "   ".str_pad("ATE 2,2%", 8, ' ', STR_PAD_LEFT);
			$Detalle .= "   ".str_pad("COSEG 3%", 8, ' ', STR_PAD_LEFT)."\r\n\r\n";
		}
