...
ON ca.\"EmpresaID\" = re.\"EmpresaID\" AND ca.\"AliasID\" = re.\"AliasID\" AND ca.\"AliasID\" <> 29
...
ORDER BY \"ItemID\", \"NumeroLiquidacion\"
		...
		while($rowL = pg_fetch_array($rs1)){
			...
			print $TipoDoc;
			print str_pad($NroDoc, 8, '0', STR_PAD_LEFT);
			print str_pad($Legajo, 8, ' ', STR_PAD_RIGHT);
			print $ModRev;
			print $EncPre;
			...
			print str_pad((int)abs($Importe), 7, '0', STR_PAD_LEFT).str_pad((int)abs(($Importe*100) % 100), 2, '0', STR_PAD_LEFT);
			...
			print str_pad($NCargo, 4, '0', STR_PAD_LEFT);
...
<form name=frmListadoIPS action=listadoIPS2018.php method=post>
