...
$sql = <<<FIN
  ...
  WHERE "ConceptoID" = 99 AND "Fecha" >= '2014-01-01' AND "Fecha" <= '2014-12-31'   
  GROUP BY e."Legajo",
  e."Nombre" || ' ' || e."Apellido"
  HAVING SUM("Haber1" + "Haber2") >= 250000
...
?>
	...
	<tr><th>Legajo</th><th>Apellido y Nombre</th><th>Cobrado</th></tr>

<?
	while($row = pg_fetch_array($rs))
	{
?>
		<tr><td><?=$row[0]?></td><td><?=$row[1]?></td><td>$ <?=number_format($row[2], 2)?></td></tr>
<?
	}
	print "</table><br>\n";
?>
